...
export const hubOnboardingSteps: TourStep[] = [
  ...
  {
    route: "/hub",
    targetId: "atividades-hub-acesso",
    title: "Suas Atividades no HUB",
    content: "Aqui é o seu atalho rápido para ver suas atividades. Você poderá ver o que está pendente, o que está em andamento e o que já concluiu de forma dinâmica.",
    buttonLabel: "Legal",
  },
  {
    route: "/hub/membro/journey/posicionamento-profissional",
    title: "Sua Jornada de Carreira",
    content: "Dentro do serviço de Posicionamento de Carreira, a entrega é dividida por Checkpoints. É aqui que os materiais, formulários e agendamentos de reuniões são apresentados para você evoluir passo a passo.",
    buttonLabel: "Entendi",
  },
  {
    route: "/hub/membro/journey/posicionamento-profissional",
