    ...
    <GlassModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-lg">
      <div className="relative flex flex-col items-center">
        ...
        <p className="text-sm text-[var(--text-secondary)] text-center mb-6 px-4">
          {nickname || "Membro"}, insira abaixo o seu CPF para resgate do cupom, e se atente aos Termos e Condicoes.
        </p>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          ...
          <div className="w-full text-left bg-[var(--input-bg)] border border-[var(--border-primary)] rounded-2xl p-4 max-h-40 overflow-y-auto text-[11px] text-[var(--text-secondary)] leading-relaxed space-y-3 custom-scrollbar">
            ...
            <div className="space-y-1.5">
              ...
              <p>2. Cada cupom esta atrelado ao CPF informado; mesmo que o cliente troque de e-mail ou matricula, o cupom nao podera ser utilizado novamente.</p>
              <p>3. O cupom e intransferivel e so pode ser usado no servico especificado na sua campanha.</p>
              <p>4. Em caso de falha ou inconsistencia, o cliente devera reportar a BPlen para que a correcao seja providenciada.</p>
