            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="p-6 bg-[var(--input-bg)] border border-[var(--border-primary)] rounded-[3rem] space-y-6 shadow-sm">
                ...
                <div className="flex items-center justify-between gap-4 mb-2">
                  ...
                  {userData.profile.driveFolderUrl && (
                    <a
                      href={userData.profile.driveFolderUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-4 py-2.5 bg-green-500/10 hover:bg-green-500/20 border border-green-500/20 hover:border-green-500/40 rounded-2xl text-[9px] font-black uppercase tracking-wider text-green-400 hover:text-green-300 transition-all shadow-sm active:scale-95"
                      title="Abrir pasta do Google Drive deste usuário"
                    >
                      <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                        <path d="M19.43 12.98l-6.73-11.53c-.34-.58-.95-.95-1.63-.95-.69 0-1.3.37-1.64.95L2.7 12.98c-.34.58-.34 1.3 0 1.88l3.37 5.76c.34.58.95.95 1.63.95h13.46c.69 0 1.3-.37 1.64-.95l3.37-5.76c.34-.58.34-1.3 0-1.88l-6.74-11.53zm-11.13 6.9l-3.37-5.76L8.3 8.35l3.37 5.76-3.37 5.77zm4.76-8.15l-3.37-5.77h6.74l3.37 5.77h-6.74zm5.72 8.15l-3.37-5.77 3.37-5.76 3.37 5.76-3.37 5.77z"/>
                      </svg>
                      <span className="hidden sm:inline">Pasta do Drive</span>
                      <ExternalLink size={10} className="opacity-70 transition-opacity" />
                    </a>
                  )}
                </div>
                  ...
                  <div className="p-6 bg-[var(--bg-primary)]/40 border border-[var(--border-primary)] rounded-[2rem] space-y-4 relative overflow-hidden">
                    ...
                    {gestaoResult?.scores ? (
                      <div className="flex flex-col items-center">
                        <div className="w-56 h-36 sm:w-64 sm:h-48 flex items-center justify-center mx-auto">
