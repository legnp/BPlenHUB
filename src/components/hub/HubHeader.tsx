...
export function HubHeader() {
  ...
  return (
    <>
      ...
      <div className="fixed top-8 left-8 transition-all hover:scale-105 duration-500 z-chrome">
      ...
      <header className="fixed top-6 right-6 z-chrome flex flex-col items-center">
