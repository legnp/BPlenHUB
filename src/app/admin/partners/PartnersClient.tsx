...
/**
 * BPlen HUB — Admin: Gestao de Parceiros (camada cliente)
 * A carga inicial vem pronta do Server Component em `page.tsx`; aqui ficam
 * apenas a interatividade e as recargas disparadas por acao do usuario.
 */
export default function PartnersClient({ initialPartners }: { initialPartners: PartnerData[] }) {
  ...
  // Recarga apos salvar ou remover. Nao existe carga inicial aqui: ela chega
  // pronta do servidor via `initialPartners`, o que evita buscar dados dentro de
  // um efeito.
  ...
  const handleDelete = async (id: string) => {
    ...
    if (res.success) refreshPartners();
  };
